    ...
    <div class="container" >
      <div class="banner_content text-left">
        ...
        <div class="page_link">
            ...
            <a href="ingreso_resultado_secrecion.php?idc=<?php echo $idcab; ?>&idp=<?php echo $idpac; ?>">Ingresar Resultados</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="container-login100" style="background: #B8E1F7;">
    ...
    <div class="wrap-login600 p-l-55 p-r-55 p-t-65 p-b-54 formu_grande">
      <!-- <form class="login100-form validate-form" method="post" action="" name="formix" id="formix"onsubmit=" return fun_insertar()"> -->
        <form class="login100-form validate-form formulario" method="post" action="app/guardarResultadoSecrecion.php?idc=<?php echo $idcab; ?>&idp=<?php echo $idpac; ?>" name="formix" id="formix">
        <!--abrir formulario cuando inicia sesion-->
            <span class="login100-form-title p-b-49">
              Examen de Secreción
            </span>

            <input type="text" value="secrecion" name="tiposeccion[]" style="display: none;">

            <div class="parados">
                <div class="row" style="width: 100%;">
                    <div class="col-md-8 m-l-20" >
                        <div class="m-t-12" style="display: flex;">
                            <label for=""><b>Paciente: </b></label><h5 class="m-l-20 m-t-2"><?php echo $nombres; ?></h5>
                ...
                <div class="row" style="width: 100%;">
                    <div class="col-md-3">
                        <div class="columna_resultado">
                            <div class="opcion_res m-l-18">
                                <select name="resultado[]" id="tiposecrecion" required>
                                    <option value="">- Area Intervenida -</option>
                    ...
                    <div class="col-md-3 m-l-50">
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <input style="width: 130px; font-size: 14px;" type="text" value="Microorganismos" name="resultado[]" readonly="">
                                </div>
                            </div>
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <input type="text" value="" name="opcion[]" required>
                                </div>
                            </div>
                        </div>    
                    </div>
...
<script src="../forms/js/selecResultadoSecrecion.js"></script>
            ...
            <div class="parados">
                ...
                <input type="text" value="En fresco" name="tiposeccion[]" style="display: none;">
            </div>
                ...
                <div class="fila_resultado parte_abajo">
                    <div class="fila_contenido_resultado">
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="celepitel" onchange="cambio22()">
                                        <option value="Celulas Epiteliales Escamosas">Celulas Epiteliales Escamosas</option>
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="bacteria" onchange="cambio23()">
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="piocito" onchange="cambio24()">
                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res m-l-20">
                                    <input type="text" name="opcion[]" id="oppiocito">
                                </div>
                            </div>
                            <div class="columna_resultado">
                            </div>
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="filamentos" onchange="cambio25()">
                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res m-l-20">
                                    <input type="text" name="opcion[]" id="opfilamentos">
                                </div>
                            </div>
                            <div class="columna_resultado">
                            </div>
...
function agregar2() {
  ...
  b2 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res m-l-2'><input type='text' name='opcion3[]' id='pl'></div></div>";

  b2 += "<div class='columna_resultado'><div class='opcion_res m-l-20'><input type='text' name='opcion3[]' id=''></div></div>";
                ...
                <div class="fila_resultado parte_abajo">
                    <div class="fila_contenido_resultado">
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="acnalse" onchange="cambio26()">
                                        <option value="Ac Nalidixico">Ac Nalidixico</option>
                                        <option value="Null">NULL</option>
                                    </select>
                                </div>
                            </div>
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="opcion[]" id="opacnalse">
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="amikacina" onchange="cambio27()">
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="clavulanico" onchange="cambio28()">
                                        <option value="Amox +AC Clavulanico">Amox +AC Clavulanico</option>
                                        <option value="Null">NULL</option>
                                    </select>
                                </div>
                            </div>
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="opcion[]" id="opclavulanico">
                                        <option value="Sensible">Sensible</option>
                                        <option value="No Sensible">No Sensible</option>
                                    </select>
                                </div>
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="celafexina" onchange="cambio29()">
                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="opcion[]" id="opcelafexina">
                                        <option value="Sensible">Sensible</option>
                                        <option value="No Sensible">No Sensible</option>
                                    </select>
                                </div>
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="ceftriaxona" onchange="cambio30()">
                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="opcion[]" id="opceftriaxona">
                                        <option value="Sensible">Sensible</option>
                                        <option value="No Sensible">No Sensible</option>
                                    </select>
                                </div>
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="levofloxacina" onchange="cambio31()">
                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="opcion[]" id="oplevofloxacina">
                                        <option value="Sensible">Sensible</option>
                                        <option value="No Sensible">No Sensible</option>
                                    </select>
                                </div>
                        ...
                        <div class="fila_agrupa_contenido">
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="resultado[]" id="tetraciclina" onchange="cambio32()">
                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res">
                                    <select name="opcion[]" id="optetraciclina">
                                        <option value="Sensible">Sensible</option>
                                        <option value="No Sensible">No Sensible</option>
                                    </select>
                                </div>
...
function agregar3() {
  ...
  b3 += "<div class='columna_resultado'><div class='opcion_res'><select name='opcion4[]' id='' style='display:none;'><option value='Null'>NULL</option><option value='Sensible'>Sensible</option><option value='No Sensible'>No Sensible</option></select><div style='color: #777777;' class='nice-select' tabindex='0'><span class='current'>-SELECCIONAR-</span><ul class='list'><li data-value='Sensible' class='option'>Sensible</li><li data-value='No Sensible' class='option'>No Sensible</li></ul></div></div></div>";
