      ...
      <div class="container">
        <div class="banner_content text-left">
          ...
          <div class="page_link">
            ...
            <a href="ingresar_empleado.php">Agregar Empleado</a>
            <a href="editar_empleado.php?ide=<?php echo $id_emp; ?>">Editar Empleado</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <form class="login100-form validate-form" method="post" action="app/modificarEmpleado.php?id=<?php echo $id_emp; ?>" name="formix" id="formix"> 
          ...
          <div class="parados">
            <div class="wrap-input100 validate-input m-b-23 m-r-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="nombres" id="nombres"required value="<?php echo $row['nombres']; ?>" onkeypress="return soloLetras(event)" placeholder="Ej: Carlos Andres">
            ...
            <div class="wrap-input100 validate-input m-b-23 m-l-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="apellidos" id="apellidos" required onkeypress="return soloLetras(event)" placeholder="Ej: Vera Perez" value="<?php echo $row['apellidos']; ?>">
              <span class="focus-input100" data-symbol="&#xf206;"></span>
            </div>
<script>
$(buscar_cedula());
  ...
  if(valr!=""){
    buscar_cedula(valr);
            ...
            <div class="wrap-input100 validate-input m-b-23 m-l-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="cedula" id="cedula" placeholder="Ej: 0912345678" value="<?php echo $row['cedula']; ?>" maxlength="10" onkeypress="return valida(event)" onchange="validarCedula()" required>
              <span class="focus-input100" data-symbol="&#xf2c3;"></span>
            </div>
            <div class="wrap-input100 validate-input m-b-23 m-l-10" data-validate = "Nombre es requerido">
              <span class="label-input100">Celular</span>
              <input class="input100" type="text" name="celular" id="celular" placeholder="Ej: 0912345678" value="<?php echo $row['celular']; ?>" maxlength="10" onkeypress="return valida(event)" required>
              <span class="focus-input100" data-symbol="&#xf2d7;"></span>
            </div>
          </div>
          ...
          <div class="parados">
            <div class="wrap-input100 validate-input m-b-23 m-r-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="telefono" id="telefono" placeholder="Ej: 2502729" value="<?php echo $row['telefono']; ?>" maxlength="10" onkeypress="return valida(event)" required>
              <span class="focus-input100" data-symbol="&#xf2bb;"></span>
            </div>
<script>
$(buscar_correo());
