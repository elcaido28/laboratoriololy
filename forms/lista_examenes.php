      ...
      <div class="banner_content text-left">
        ...
        <div class="page_link">
          ...
          <a href="buscar_examenes.php">Buscar Examenes</a>
           <a href="https://www.laboratoriololy.com/forms/buscar_examenes.php" class="">Lista de Examenes</a> 
          <!--<a href="lista_examenes.php?idc=<?php echo $idcab; ?>&idp=<?php echo $idpac; ?>">Lista de Examenes</a>-->
        </div>
      </div>
    </div>
  </div>
