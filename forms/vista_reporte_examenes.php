...
<!--================Header Menu Area =================-->
      ...
      <div class="container">
        <div class="banner_content text-left">
          ...
          <div class="page_link">
            ...
            <a href="vista_reporte_examenes.php">Reporte Examenes</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-login100" style="background: #B8E1F7;">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 m-b-50">
        <form class="login100-form validate-form" method="post" action="report\reporte_examenes.php" name="formix" id="formix" target="_blank">   <!--abrir formulario cuando inicia sesion-->
          ...
          <div class="m-b-23 m-l-10" >
                <select class="input100 espacio_combo"  name="tipo_examen">
                  <option value="">-SEECCIONE-</option>
                  <option value="1">Examen Orina</option>
                  <option value="2">Examen Fisico - Quimico de Orina</option>
                  <option value="3">Examen de Sangre</option>
                  <option value="4">Examen de Sangre - Embarazo</option>
                  <option value="5">Examen de Secreción</option>
                  <option value="6">Examen Biometrí­a Hemática</option>
                </select>
          </div>
          <br><br>
