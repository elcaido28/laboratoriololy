...
$consulta3=mysqli_query($con,"SELECT * from empleado P inner join usuario U on U.id_empleado=P.id_empleado WHERE P.cedula='$cedula' and P.correo='$email' and P.id_estado='1'");
