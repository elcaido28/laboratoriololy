...
<!--================Header Menu Area =================-->
      ...
      <div class="container">
        <div class="banner_content text-left">
          ...
          <div class="page_link">
            ...
            <a href="vista_reporte_Exa_X_pacientes.php">Reporte Examenes por Pacientes</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-login100" style="background: #B8E1F7;">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 m-b-50">
        <form class="login100-form validate-form" method="post" action="report\reporte_examen_x_pacientes.php" name="formix" id="formix" target="_blank">   <!--abrir formulario cuando inicia sesion-->
