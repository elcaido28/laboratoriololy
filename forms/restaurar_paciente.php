            ...
            <div class="table-responsive">
                <div class="cont_tabla">
                    <table class="tabla" >
                        ...
                        <tr>
                        <?php
                            $consulta3=mysqli_query($con,"SELECT * from paciente P inner join estado E on P.estado=E.id_estado inner join sexo S on P.sexo=S.id_sexo WHERE estado='2'");
                        ...
                        ?>
                            ...
                            <td>
                                <div class="cont_tbn_tb">
                                    <button type="button" class="eliminar" title="Restaurar" id="<?php echo $row3['id_paciente'] ?>" name="button" id="elim"><i class="fas fa-redo-alt" id="<?php echo $row3['id_paciente'] ?>"></i>
                                    </button>
                                </div>
...
$('.eliminar').click(function(e){
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.value) {
      document.location.href="app/restaurarPaciente.php?id="+id_emp;
    } else if (
