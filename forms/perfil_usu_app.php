    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body" style="max-height: 370px;">
        <div class="accordion-item-body-content">
          ...
          <div class="conten_botom_formu3" id="btn1">
      ...
      <div class="accordion-item-body">
        <div class="accordion-item-body-content">
          ...
          <div class="cont_cajas3">
            ...
            <input type="text" class="caja_input" name="contrasena" id="contra1" value="" required autocomplete="off">
          </div>
          <div class="cont_cajas3">
            <label class="etiq_caja3">Nueva Contraseña</label>
            <input type="text" class="caja_input" name="clave" id="contra2" value="" required autocomplete="off">
          </div>
          <div class="cont_cajas3">
            <label class="etiq_caja3">Repita Nueva Contraseña</label>
            <input type="text" class="caja_input" name="rclave" id="contra3" value=""  required autocomplete="off">
          </div>
          <div class="conten_botom_formu3" id="btn2">
...
//     var caja1=document.getElementById('contra1').value;
//     var caja2=document.getElementById('contra2').value;
//     var caja3=document.getElementById('contra3').value;
