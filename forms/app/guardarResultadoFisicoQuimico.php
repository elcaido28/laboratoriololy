...
// SECCION 2
		...
		for ($d=0; $d < $num4; $d++) {
			...
			if ($conta4<3) {
				...
				if ($conta4==2) {
					...
					$nresultado4 = $ver4[1];
					$nopcion4 = $ver4[2];
					$cadena = "INSERT INTO detalle_resultado SET detalle_resultado_seccion='$seccion2', detalle_resultado_tipoexa='$nresultado4', detalle_resultado_resul='$nopcion4', cabecera_resultado_id='$idcab'";
					mysqli_query($con,$cadena);
					$conta4 = 0;
					$contenido4 = '';
				}
	...
	// header("Location:../ingreso_resultado_fisico_quimico.php?idc=$idcabecera&idp=$idpac");
