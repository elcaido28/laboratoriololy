  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2>Búsqueda Pacientes</h2>
        <div class="page_link">
          <a href="inicio.php">Inicio</a>
          <a href="busqueda_paciente.php">Buscar Pacientes</a>
        </div>
      </div>
    </div>
  </div>
                        ...
                        ?>
                            ...
                            <td>
                                <div class="cont_tbn_tb">
                                    ...
                                    <button type="button" class="eliminar m-l-5" title="Eliminar" id="<?php echo $row3['id_paciente'] ?>" name="button" id="elim"><i class="far fa-trash-alt" id="<?php echo $row3['id_paciente'] ?>"> </i>
                            </button>
                                </div>
