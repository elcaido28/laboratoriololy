...
<?php
  $id_rol=$_REQUEST['idr'];
  $consulta=mysqli_query($con,"SELECT * FROM rol WHERE id_rol='$id_rol'");
...
<script>
  ...
  <div class="container-login100" style="background: #B8E1F7;">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="margin-top: -180px;">
        <form class="login100-form validate-form" method="post" action="app/modificarRol.php?idr=<?php echo $id_rol; ?>" name="formix" id="formix">   <!--abrir formulario cuando inicia sesion-->
          ...
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
            ...
            <input class="input100" type="text" name="rol" id="rol" value="<?php echo $row['nombre_rol']; ?>" onkeypress="return soloLetras(event)" placeholder="Ej: Empleado" required>
          ...
          <div class="container-login100-form-btn">
            ...
            <div class="wrap-login40-form-btn-cancelar">
              ...
              <a href="ingresar_cargo.php" class="txt2">
